...
${OBJECTDIR}/source/Instrument.o: source/Instrument.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/source/Instrument.o source/Instrument.cpp

${OBJECTDIR}/source/Notes/Note.o: source/Notes/Note.cpp 
	${MKDIR} -p ${OBJECTDIR}/source/Notes
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/source/Notes/Note.o source/Notes/Note.cpp

${OBJECTDIR}/source/Notes/SawNote.o: source/Notes/SawNote.cpp 
	${MKDIR} -p ${OBJECTDIR}/source/Notes
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/source/Notes/SawNote.o source/Notes/SawNote.cpp

${OBJECTDIR}/source/Notes/SinNote.o: source/Notes/SinNote.cpp 
	${MKDIR} -p ${OBJECTDIR}/source/Notes
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/source/Notes/SinNote.o source/Notes/SinNote.cpp

${OBJECTDIR}/source/Notes/TriNote.o: source/Notes/TriNote.cpp 
	${MKDIR} -p ${OBJECTDIR}/source/Notes
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/source/Notes/TriNote.o source/Notes/TriNote.cpp

${OBJECTDIR}/source/Sample.o: source/Sample.cpp 
	${MKDIR} -p ${OBJECTDIR}/source
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/source/Sample.o source/Sample.cpp

${OBJECTDIR}/source/SongPlayer.o: source/SongPlayer.cpp 
	${MKDIR} -p ${OBJECTDIR}/source
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/source/SongPlayer.o source/SongPlayer.cpp

${OBJECTDIR}/source/SoundLimiter.o: source/SoundLimiter.cpp 
	${MKDIR} -p ${OBJECTDIR}/source
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/source/SoundLimiter.o source/SoundLimiter.cpp
...
${OBJECTDIR}/source/SoundWorld.o: source/SoundWorld.cpp 
	${MKDIR} -p ${OBJECTDIR}/source
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/source/SoundWorld.o source/SoundWorld.cpp
